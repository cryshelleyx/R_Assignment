...
```{r, echo = TRUE}
# read data in 
cc <- read_csv('_posts\\2021-07-26-r-assignment\\MC2\\cc_data.csv')
loyalty <- read_csv('_posts\\2021-07-26-r-assignment\\MC2\\loyalty_data.csv')
locationmapping <- read_csv('_posts\\2021-07-26-r-assignment\\MC2\\LocationMapping.csv')
ap <- raster("C:\\Study\\MITB Term 3\\ISSS608 Visual Analytics\\Lesson08\\In-class_Ex08\\Geospatial\\MC2-tourist.tif")
gps <- read_csv('_posts\\2021-07-26-r-assignment\\MC2\\gps.csv')
...
abila_st <- st_read(dsn = '_posts\\2021-07-26-r-assignment\\MC2\\Geospatial',
                    layer = "Abila")
...
```{r}
car_cc <- read_excel('_posts\\2021-07-26-r-assignment\\MC2\\car_cc.xlsx')
car_assign <- read_csv('_posts\\2021-07-26-r-assignment\\MC2\\car-assignments.csv')
